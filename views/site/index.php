                ...
                <div class="col-sm-9 padding-right">
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        ...
                                        <?php if($product['is_new']) : ?>
                                            <img src = "/templates/images/home/new.png" class = "new">
                                        <?php endif; ?>
                    ...
                    <div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <?php foreach($recomendProducts as $itemRecomended): ?>
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <h2>$<?php echo $itemRecomended['price'];?></h2>
                                                <p><?php echo $itemRecomended['name'];?></p>
                                                <a href="/cart/add/<?php echo $itemRecomended['id'];?>" data-id="<?php echo $product['id']; ?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>В корзину</a>
                                            </div>
